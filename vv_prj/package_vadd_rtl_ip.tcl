ipx::package_project -root_dir ../ip_repo -vendor xilinx.com -library user -taxonomy /UserIP -generated_files -import_files -set_current false
ipx::edit_ip_in_project -upgrade true -name tmp_edit_project -directory ../ip_repo ../ip_repo/component.xml
set_property top vadd_rtl [get_filesets sim_1]
...
set_property value m_axi:s_axi [ipx::get_bus_parameters ASSOCIATED_BUSIF -of_objects [ipx::get_bus_interfaces ap_clk -of_objects [ipx::current_core]]]
